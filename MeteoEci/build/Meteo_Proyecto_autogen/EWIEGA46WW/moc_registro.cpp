...
QT_MOC_LITERAL(1, 9, 15), // "registro_signal"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 24), // "std::vector<std::string>"
QT_MOC_LITERAL(4, 51, 14), // "datos_registro"
QT_MOC_LITERAL(5, 66, 21) // "on_pushButton_clicked"

    },
    "Registro\0registro_signal\0\0"
...
void Registro::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->registro_signal((*reinterpret_cast< std::vector<std::string>(*)>(_a[1]))); break;
        ...
        {
            typedef void (Registro::*_t)(std::vector<std::string> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Registro::registro_signal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Registro::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Registro.data,
...
// SIGNAL 0
void Registro::registro_signal(std::vector<std::string> _t1)
{
